                                        ...
                                        <ul class="navbar-nav flex-column">
                                            <li class="nav-item">
                                                <RouterLink class="nav-link"
                                                    :to="{ name: 'admin', params: { page: 'global' } }"
                                                    active-class="active" @click="goNoTransition"><i
                                            ...
                                            <li class="nav-item">
                                                <RouterLink class="nav-link"
                                                    :to="{ name: 'admin', params: { page: 'navbar' } }"
                                                    active-class="active" @click="goNoTransition"><i
                                            ...
                                            <li class="nav-item">
                                                <RouterLink class="nav-link"
                                                    :to="{ name: 'admin', params: { page: 'users' } }"
                                                    active-class="active" @click="goNoTransition"><i
                                            ...
                                            <li class="nav-item">
                                                <RouterLink class="nav-link"
                                                    :to="{ name: 'admin', params: { page: 'groups' } }"
                                                    active-class="active" @click="goNoTransition"><i
