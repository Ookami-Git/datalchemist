    ...
    <div class="card">
        ...
        <div class="card-body" v-if="parameter">
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="input-group mb-3">
                        <label class="input-group-text" for="inputSelectView">{{ $t('admin.global.defaultview')
                        }}</label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="input-group input-group-sm">
                                ...
                                <input type="color" id="bg_color_light" v-model="parameter.bg_color_light"
                                    class="form-control form-control-color">
                                <input type="color" id="bg_color2_light" v-model="parameter.bg_color2_light"
                                    class="form-control form-control-color">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="input-group input-group-sm">
                                ...
                                <input type="color" id="bg_color_dark" v-model="parameter.bg_color_dark"
                                    class="form-control form-control-color">
                                <input type="color" id="bg_color2_dark" v-model="parameter.bg_color2_dark"
                                    class="form-control form-control-color">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input hidden" type="checkbox" tabindex="0"
                                    name="[ldapEnable]:boolean" v-model="parameter.ldap">
                        ...
                        <div class="col-md-4">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input hidden" type="checkbox" tabindex="0"
                                    name="[ldapSsl]:boolean" v-model="parameter.ldap_ssl">
                        ...
                        <div class="col-md-4">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input hidden" type="checkbox" tabindex="0"
                                    name="[ldapCheckCert]:boolean" v-model="parameter.ldap_skip_verify">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="input-group mb-3">
                                ...
                                <input type="number" class="form-control" name="[ldapPort]" placeholder="389 / 636"
                                    min="0" v-model="parameter.ldap_port">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="input-group mb-3">
                                <span class="input-group-text">{{ $t('admin.global.ldap.basedn') }}</span>
                                <input type="text" class="form-control" name="[ldapBaseDN]"
                                    v-model="parameter.ldap_base_dn">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="input-group mb-3">
                                <span class="input-group-text">{{ $t('admin.global.ldap.login') }}</span>
                                <input type="text" class="form-control" name="[ldapFilter]"
                                    placeholder="uid, samaccountname, mail, ..." v-model="parameter.ldap_filter">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="input-group mb-3">
                                ...
                                <input type="password" class="form-control" name="[ldapPassword]"
                                    v-model="parameter.ldap_password">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" v-model="parameter.export_csv_delimiter"
                                    placeholder="Example --> ; , |">
                            </div>
                        </div>
                    </div>
